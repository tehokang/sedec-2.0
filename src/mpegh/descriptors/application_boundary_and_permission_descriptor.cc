/** **********************************************************************************************************
	@file 		application_boundary_and_permission_descriptor.cpp
...
ApplicationBoundaryAndPermissionDescriptor::ApplicationBoundaryAndPermissionDescriptor(BitReadWriter *rw) : Descriptor(rw)
{
...
{
    SECTION_DEBUG("\n");
    SECTION_DEBUG("\tdescriptor_tag : 0x%04x (application_boundary_and_permission_descriptor)\n", descriptor_tag);
...
void ApplicationBoundaryAndPermissionDescriptor::WriteDescriptor(BitReadWriter *rw)
{
